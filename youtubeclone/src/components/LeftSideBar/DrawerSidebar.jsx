        ...
        <div className='container2_DrawerLeftSidebar'>
            <div className='Drawer_leftsidebar'>
                <NavLink to={'/'} className="icon_sidebar_div">
                    ...
                    <div className="icon_sidebar_div"><p>
                        <MdOutlineExplore size = {22} className='icon_sidebar' style = {{margin:"auto 0.7rem"}}/>
                        <div className="text_sidebar_icon">Explore</div>
                    </p>
                    </div>
                    <div className="icon_sidebar_div"><p>
                        <img src = {shorts} alt ="" size = {22} className='icon_sidebar' style = {{margin:"auto 0.7rem"}}/>
                    ...
                    <NavLink to = {'/likedvideos'} className="icon_sidebar_div"><p>
